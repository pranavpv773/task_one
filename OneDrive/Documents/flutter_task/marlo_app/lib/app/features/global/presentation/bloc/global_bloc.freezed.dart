...
class __$$ChangeIndexCopyWithImpl<$Res>
    extends _$GlobalEventCopyWithImpl<$Res, _$ChangeIndex>
...
class _$ChangeIndex implements ChangeIndex {
  ...
  @override
  String toString() {
    return 'GlobalEvent.changeIndex(index: $index)';
  }
...
abstract class ChangeIndex implements GlobalEvent {
...
class _$_GlobalState implements _GlobalState {
  _$_GlobalState({required this.currentIndex});
  ...
  @override
  String toString() {
    return 'GlobalState(currentIndex: $currentIndex)';
  }
...
abstract class _GlobalState implements GlobalState {
  factory _GlobalState({required final int currentIndex}) = _$_GlobalState;
